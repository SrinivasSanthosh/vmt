...
<nav class="navbar navbar-expand-lg navbar-light" style= "background-color: #575cc1;color:white;">
   <div class="container-fluid">
      <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6 pull-left">
         <h3><img src="http://blockchain-coffee-web.mybluemix.net/assets/images/ibm-logo-white.png" style="width:10%;height:10%"/> &nbsp;GTS Vendor Inquiry Tool</h3>
      </div>
...
<div class="container-table100">
   ...
   <br>
   <?php
      showTable(getCustomerData($_REQUEST['custgeo']));
      showCountryTable_datacenter(getCustomerData_datacenter($_REQUEST['custgeo']));
      }
      }    
      ?>
</div>
...
=======
                    ...
                    <div class="col-lg-3 col-md-3 market-search" style="display: none;">
                    <div class="well">
                        <h3 class="text-primary text-center"><i class="fa fa-fw fa-outdent" style="font-size:28px;"></i>Market Search</h3></br>
                    </div>
                    </div>
                    <div class="col-lg-3 col-md-3 market-search" style="display: none;">
                    <div class="well">
                    ...
                    <div class="col-lg-3 col-md-3 cust-search" style="display: none;">
                    <div class="well">
                    <h3 class="text-primary text-center"><i class="fa fa-fw fa-user" style="font-size:28px;"></i>Customer Search</h3></br>
                    </div>
                    </div>
                    <div class="col-lg-3 col-md-3 cust-search" style="display: none;">
                    <div class="well customer-search">
                        </br><div class="customer-search-span">
                        <?php
                            ?>
                        <select  id='cust_search' multiple='multiple' placeholder='Select Customers' class='form-control' name='custgeo[]'>
                        </select>
                  ...
                  <div class="panel panel-info">
                 <div class="panel-heading"><center><h4 style="color:green;">OPTIONAL FIELDS</h4></center></div>
                  </div>
