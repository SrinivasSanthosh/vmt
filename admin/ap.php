...
<<<<<<< HEAD
  ...
  <?php
    if (isset($_REQUEST['submit'])) {
       ...
       Validate_data('ap_geo');  //  Displaying Selected Value
    }
    ?>
=======
...
<<<<<<< HEAD
          <h2><i class="glyphicon glyphicon-user"></i>Query from asia pacific</h2>
        </div>
           ...
           <tbody>
            ...
            for($i=0; $i < count($globalTool); $i++) {
              ...
              <tr>
                ...
                <td><?php echo $globalTool[$i]['account_name']; ?></td>
