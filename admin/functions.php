...
function getGlobalTool($table) {
	...
	$i = 0;
	while($output = mysqli_fetch_array($result)) {
		$return_array[$i]['procurement_reference'] = $output['procurement_reference'];
		$return_array[$i]['entity_name'] = $output['entity_name'];
		$return_array[$i]['supplier_address'] = $output['country'];
		$return_array[$i]['sub_contract_vendors'] = $output['sub_contract_vendors'];
		$return_array[$i]['tool_name'] = $output['tool_name'];
		$return_array[$i]['vendor_description'] = $output['vendor_description'];
		$return_array[$i]['on_boarding'] = $output['on_boarding'];
		$return_array[$i]['off_boarding'] = $output['off_boarding'];
		$return_array[$i]['tool_owner'] = $output['tool_owner'];
		$return_array[$i]['assessment_owner'] = $output['assessment_owner'];
...
function getGlobalOffering($table) {
	...
	while($output = mysqli_fetch_array($result)) {
		...
		$return_array[$i]['supplier_address'] = $output['country'];
		$return_array[$i]['sub_contract_vendors'] = $output['sub_contract_vendors'];
		$return_array[$i]['offering_id_30'] = $output['offering_id_30'];
		$return_array[$i]['offering_id_40'] = $output['offering_id_40'];
		$return_array[$i]['vendor_description'] = $output['vendor_description'];
		$return_array[$i]['on_boarding'] = $output['on_boarding'];
		$return_array[$i]['off_boarding'] = $output['off_boarding'];
		$return_array[$i]['offering_owner'] = $output['offering_owner'];
		$return_array[$i]['assessment_owner'] = $output['assessment_owner'];
		$return_array[$i]['note'] = $output['note'];
		$i++;
	}
...
function getEUTool($table) {
	...
	while($output = mysqli_fetch_array($result)) {
		...
		$return_array[$i]['full_supplier_address'] = $output['country'];
		...
		$return_array[$i]['customer_identified'] = $output['customer_identified'];
		...
		$return_array[$i]['market_done'] = $output['market_done'];
		$return_array[$i]['action_owner'] = $output['action_owner'];
		$return_array[$i]['data_input_complete'] = $output['data_input_complete'];
		$return_array[$i]['next_person_chase'] = $output['next_person_chase'];
		$return_array[$i]['check_ok'] = $output['check_ok'];
		$return_array[$i]['po_close'] = $output['po_close'];
		$i++;
	}
	return $return_array;
}
function getnageo($table) {
	...
	while($output = mysqli_fetch_array($result)) {
		$return_array[$i]['po_number'] = $output['po_number'];
		$return_array[$i]['procurement_vendor_id'] = $output['procurement_vendor'];
		$return_array[$i]['supplier_name'] = $output['supplier_name'];
		...
		// $return_array[$i]['next_person_chase'] = $output['next_person_chase'];
		// $return_array[$i]['check_ok'] = $output['check_ok'];
		$return_array[$i]['fp'] = $output['fp_tm'];
		$i++;
	}
	return $return_array;
}
...
function getgcggeo($table) {
	...
	while($output = mysqli_fetch_array($result)) {
		...
		$return_array[$i]['account_wbs'] = $output['account_wbs'];
		$return_array[$i]['customer_contact'] = $output['customer_contact'];
		$return_array[$i]['country'] = $output['country'];
		$return_array[$i]['account'] = $output['account'];
		$return_array[$i]['final_ra'] = $output['final_ra'];
		$return_array[$i]['dpe_contact'] = $output['dpe_contact'];
		$return_array[$i]['po_amount'] = $output['po_amount'];
		$return_array[$i]['comgroup_cd'] = $output['comgroup_cd'];
		$return_array[$i]['matlgrp_id'] = $output['matlgrp_id'];
		$return_array[$i]['comgroup_cd_disc'] = $output['comgroup_cd_disc'];
		$return_array[$i]['matlgrp_id_disc'] = $output['matlgrp_id_disc'];
		$i++;
	}	
	return $return_array;
}
...
function getapgeo($table) {
	...
	while($output = mysqli_fetch_array($result)) {
		...
		$return_array[$i]['identify_customer'] = $output['identify_customer'];
		$return_array[$i]['note'] = $output['note'];
		$return_array[$i]['account_name'] = $output['account_name'];
