...
<div id="content" class="col-lg-10 col-sm-10">
   ...
   <?php
      ...
      Validate_data('gcg_geo');  //  Displaying Selected Value
      }
      ?>
   <div class="row">
      <div class="box col-md-12">
         <div class="box-inner">
            <div class="box-header well" data-original-title="">
               <h2><i class="glyphicon glyphicon-user"></i>Query from Gcg</h2>
            </div>
          ...
          <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
            <thead>
              <tr>
               ...
               <th>COMGROUP_CD</th>
               <th>MATLGRP_ID</th>
               <th>COMGROUP_CD-DISCRIPTION</th>
               <th>MATLGRP_ID-DISCRIPTION</th>
           ...
           <tbody>
            ...
            for($i=0; $i < count($globalTool); $i++) {
              ...
              <tr>
                ...
                <td><?php echo $globalTool[$i]['account_wbs']; ?></td>
                <td><?php echo $globalTool[$i]['customer_contact']; ?></td>
                <td><?php echo $globalTool[$i]['country']; ?></td>
                <td><?php echo $globalTool[$i]['account']; ?></td>
                <td><?php echo $globalTool[$i]['final_ra']; ?></td>
                <td><?php echo $globalTool[$i]['dpe_contact']; ?></td>
                <td><?php echo $globalTool[$i]['comgroup_cd']; ?></td>
                <td><?php echo $globalTool[$i]['matlgrp_id']; ?></td>
                <td><?php echo $globalTool[$i]['comgroup_cd_disc']; ?></td>
                <td><?php echo $globalTool[$i]['matlgrp_id_disc']; ?></td>
