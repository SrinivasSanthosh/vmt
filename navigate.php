         ...
         <div class="col-lg-6 col-md-6 pull-right">
            <div class="btn-group pull-right">
               ...
               <ul class="dropdown-menu" aria-labelledby="usermenu">
                  <li><a href="#"><a href="#"><i class="fa fa-fw fa-user faa-tada animated"></i><?php echo $username ?></a>  </li>
                  <li class="divider"></li>
...
<div class="col-lg-2 col-md-2">
   <nav id="sidebar">
      ...
      <ul style="background-color: #575cc1;color: white;">
         ...
         <li>
            <h5> <a href="offering.php"> <i class="fa fa-fw fa-outdent" style="color: white;"></i>Offering Search</a></h5>
         </li>
         <li>
